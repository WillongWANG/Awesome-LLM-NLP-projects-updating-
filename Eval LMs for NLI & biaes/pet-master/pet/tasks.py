...
class MnliProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        return self._create_examples(MnliProcessor._read_tsv(os.path.join(data_dir, "multinli_1.0_train.jsonl")), "train")

    def get_dev_examples(self, data_dir):
        return self._create_examples(MnliProcessor._read_tsv(os.path.join(data_dir, "dev_matched_sampled-1.jsonl")), "dev_matched")
...
class MnliMismatchedProcessor(MnliProcessor):
    ...
    def get_dev_examples(self, data_dir):
        return self._create_examples(self._read_tsv(os.path.join(data_dir, "dev_mismatched_sampled-1.jsonl")), "dev_mismatched")
...
def load_examples(task, data_dir: str, set_type: str, *_, num_examples: int = None,
    ...
    if set_type == DEV_SET:
        ...
        for example in examples:
            example.label = processor.get_labels()[0] # "contradiction"
    else:
