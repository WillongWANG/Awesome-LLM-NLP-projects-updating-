...
def main():
    ...
    parser.add_argument("--model_type", default="bert", type=str, required=True, choices=MODEL_CLASSES.keys(),
                        help="The type of the pretrained language model to use")
    parser.add_argument("--model_name_or_path", default="google-bert/bert-base-uncased", type=str, required=True, # huggingface
                        help="Path to the pre-trained model or shortcut name")
    parser.add_argument("--task_name", default="mnli", type=str, required=True, choices=PROCESSORS.keys(), # mnli-mm
    ...
    parser.add_argument("--pattern_ids", default=[0,1,2,3], type=int, nargs='+', ###
    ...
    parser.add_argument("--alpha", default=0.9999, type=float, ### 即原文0.0001
    ...
    parser.add_argument("--pet_max_steps", default=250, type=int, ### overrides ``num_train_epochs``, wrapper.py line 251
    ...
    parser.add_argument('--sc_gradient_accumulation_steps', type=int, default=4,
    ...
    parser.add_argument("--sc_max_steps", default=250, type=int, ### 同理overrides
